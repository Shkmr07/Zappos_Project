  ...
  return (
    <div className='contact'>
        ...
        <div className='contact-info'>
            ...
            <p>Can't find what you need? Our Customer Loyalty Team is available 24/7 for anything you need! (Zappos believes strongly in a healthy work life balance for employees, so we typically close our support channels on several major U.S. holidays, including: New Year’s Day, MLK Day, President’s Day, Memorial Day, Independence Day, Labor Day, Thanksgiving Day, and Christmas Day.)</p>
            ...
            <p>Text CHAT to 1-833-927-7898 to chat with the Zappos Customer Loyalty Team by text. Agents are available to text daily from 5am - 8pm PST.</p>
